...
import { ChevronDown, FileText, Gavel, Settings } from "lucide-react";
...
export const SettingsMenu: React.FC = () => {
  ...
  const [isOpen, setIsOpen] = React.useState(
    ...
    location.pathname === "/game/privacy-policy" ||
    location.pathname === "/game/lgpd"
  );
      ...
      <CollapsibleTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            (location.pathname === "/game/settings" || location.pathname === "/game/privacy-policy" || location.pathname === "/game/lgpd") && "bg-muted text-primary"
          )}
        >
